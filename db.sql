...
--id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  ...
  banheiro_privativo CHAR(1) CHECK (banheiro_privativo IN ('S', 'N')),
...
--id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  ...
  CHECK (stats IN ('pendente', 'confirmada', 'cancelada'))
--status status_reserva NOT NULL, status eh palavra reservada po jkkkkkkk
